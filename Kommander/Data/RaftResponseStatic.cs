...
{
    public static readonly RaftResponse NoneResponse = new(RaftResponseType.None);
    ...
    /// </summary>
    public static readonly RaftResponse ProposalQueueFullResponse = new(
    ...
    /// </summary>
    public static readonly RaftResponse RestoreInProgressResponse = new(
        RaftResponseType.None,
    ...
    /// </summary>
    public static readonly RaftResponse PartitionMovedResponse = new(
        RaftResponseType.None,
