...
internal sealed class RaftPartitionHostAdapter : Scheduling.IRaftPartitionHost
{
    ...
    public long GetLastNodeActivityTicks(string endpoint, int partitionId) => manager.GetLastNodeActivityTicks(endpoint, partitionId);
    ...
    public IRaftPartitionStateTransfer? PartitionStateTransfer => manager.PartitionStateTransfer;
