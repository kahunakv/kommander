...
public class TestRaftOperationMapper
{
    ...
    [InlineData(RaftRequestType.ForceLeaderForTesting)]
    [InlineData(RaftRequestType.StepDown)]
    [InlineData(RaftRequestType.TransferLeadership)]
    [InlineData(RaftRequestType.SuspendHeartbeats)]
    [InlineData(RaftRequestType.ResumeHeartbeats)]
    [InlineData(RaftRequestType.ReceiveStepDownNotice)]
    [InlineData(RaftRequestType.ReceiveTransferLeadership)]
    ...
    [InlineData(RaftRequestType.ForceLeaderForTesting, RaftOperationPriority.Control)]
    [InlineData(RaftRequestType.StepDown, RaftOperationPriority.Control)]
    [InlineData(RaftRequestType.TransferLeadership, RaftOperationPriority.Control)]
    [InlineData(RaftRequestType.SuspendHeartbeats, RaftOperationPriority.Control)]
    [InlineData(RaftRequestType.ResumeHeartbeats, RaftOperationPriority.Control)]
    [InlineData(RaftRequestType.ReceiveStepDownNotice, RaftOperationPriority.Control)]
    [InlineData(RaftRequestType.ReceiveTransferLeadership, RaftOperationPriority.Control)]
    ...
    [InlineData(RaftRequestType.ForceLeaderForTesting, RaftStatePriority.High)]
    [InlineData(RaftRequestType.StepDown, RaftStatePriority.High)]
    [InlineData(RaftRequestType.TransferLeadership, RaftStatePriority.High)]
    [InlineData(RaftRequestType.SuspendHeartbeats, RaftStatePriority.High)]
    [InlineData(RaftRequestType.ResumeHeartbeats, RaftStatePriority.High)]
    [InlineData(RaftRequestType.ReceiveStepDownNotice, RaftStatePriority.High)]
    [InlineData(RaftRequestType.ReceiveTransferLeadership, RaftStatePriority.High)]
